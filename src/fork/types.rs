...
pub struct GovernanceExport {
    ...
    // Expanded dimensions (Version 2.0)
    #[serde(default)]
    pub nested_multisig_teams: Option<serde_json::Value>,
    #[serde(default)]
    pub governance_review_policy: Option<serde_json::Value>,
    #[serde(default)]
    pub repository_layers: Option<serde_json::Value>,
    #[serde(default)]
    pub tier_classification: Option<serde_json::Value>,
    #[serde(default)]
    pub emergency_procedures: Option<serde_json::Value>,
    #[serde(default)]
    pub cross_layer_rules: Option<serde_json::Value>,
    #[serde(default)]
    pub commons_contributor_thresholds: Option<serde_json::Value>,
    #[serde(default)]
    pub validation_requirements: Option<serde_json::Value>,
